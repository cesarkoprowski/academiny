...
export default function ActivityDetailsPage() {
  ...
  let [activity, setActivity] = useState<any>(null);
  const [isLoading, setIsLoading] = useState(true);

  useEffect(() => {
    async function load() {
      try {
        const data = await getActivityById(String(id));
        setActivity(data);
      } catch (err) {
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    ...
                    vulnerabilidade social. Através de uma abordagem
                    colaborativa, os participantes desenvolverão aplicações e
                    sistemas que atendam demandas específicas identificadas
                  ...
                  <p>
                    ...
                    contribuir para a transformação social através da
                    tecnologia.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Desenvolver soluções tecnológicas alinhadas com
                      necessidades sociais reais
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary shrink-0 mt-0.5" />
